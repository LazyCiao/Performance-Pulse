...
SECRET_KEY = 'django-insecure-k*7$c3#b1^k3xf#r98i)vqs09%n6c6#k#x9=u^p5e8%k&n)jae'
...
INSTALLED_APPS = [
    ...
    'financial_pulse.apps.FinancialPulseConfig',
...
ROOT_URLCONF = 'performance_pulse.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'performance_pulse', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
